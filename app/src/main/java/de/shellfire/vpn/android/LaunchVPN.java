...
import de.shellfire.vpn.android.openvpn.IServiceStatus;
import de.shellfire.vpn.android.openvpn.OpenVPNStatusService;
import de.shellfire.vpn.android.openvpn.PasswordCache;
import de.shellfire.vpn.android.openvpn.Preferences;
...
public class LaunchVPN extends Activity {
    ...
    protected void startVpnFromIntent() {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder binder) {
            ...
            try {
                ...
                Log.e(TAG, "Failed to set cached password", e);
            }
    ...
    private void askForPW(final int type) {
        ...
        if (type == R.string.password) {
            ...
            ((EditText) userpwlayout.findViewById(R.id.password_login)).setText(mSelectedProfile.mPassword);
            ...
            ((CheckBox) userpwlayout.findViewById(R.id.show_password)).setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                    if (isChecked)
                        ((EditText) userpwlayout.findViewById(R.id.password_login)).setInputType(InputType.TYPE_CLASS_TEXT | InputType.TYPE_TEXT_VARIATION_VISIBLE_PASSWORD);
                    else
                        ((EditText) userpwlayout.findViewById(R.id.password_login)).setInputType(InputType.TYPE_CLASS_TEXT | InputType.TYPE_TEXT_VARIATION_PASSWORD);
                }
            });
                ...
                new OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (type == R.string.password) {
                            ...
                            String pw = ((EditText) userpwlayout.findViewById(R.id.password_login)).getText().toString();
