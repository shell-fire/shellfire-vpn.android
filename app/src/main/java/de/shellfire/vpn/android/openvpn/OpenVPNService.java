...
import static de.shellfire.vpn.android.openvpn.ConnectionStatus.LEVEL_CONNECTED;
import static de.shellfire.vpn.android.openvpn.ConnectionStatus.LEVEL_WAITING_FOR_USER_INPUT;
import static de.shellfire.vpn.android.openvpn.NetworkSpace.IpAddress;
...
import de.shellfire.vpn.android.MainBaseActivity;
import de.shellfire.vpn.android.R;
import de.shellfire.vpn.android.api.ExternalAppDatabase;
...
public class OpenVPNService extends VpnService implements StateListener, Callback, ByteCountListener, IOpenVPNServiceInternal {
    public static final String START_SERVICE = "de.shellfire.vpn.android.START_SERVICE";
    public static final String START_SERVICE_STICKY = "de.shellfire.vpn.android.START_SERVICE_STICKY";
    public static final String ALWAYS_SHOW_NOTIFICATION = "de.shellfire.vpn.android.NOTIFICATION_ALWAYS_VISIBLE";
    public static final String DISCONNECT_VPN = "de.shellfire.vpn.android.DISCONNECT_VPN";
    ...
    public static final String EXTRA_CHALLENGE_TXT = "de.shellfire.vpn.android.openvpnCR_TEXT_CHALLENGE";
    public static final String EXTRA_CHALLENGE_OPENURL = "de.shellfire.vpn.android.openvpnOPENURL_CHALLENGE";
    private static final String PAUSE_VPN = "de.shellfire.vpn.android.PAUSE_VPN";
    private static final String RESUME_VPN = "de.shellfire.vpn.android.RESUME_VPN";
    ...
    private final String TAG = "OpenVPN";
    ...
    public IBinder onBind(Intent intent) {
        Log.d(TAG, "OpenVPNService onBind, intent=" + intent);
    ...
    synchronized void unregisterDeviceStateReceiver() {
        if (mDeviceStateReceiver != null)
            try {
                ...
                // java.lang.IllegalArgumentException: Receiver not registered: de.shellfire.vpn.android.NetworkSateReceiver@41a61a10
                // Ignore for now ...
                Log.e(TAG, "unregisterDeviceStateReceiver: " + iae.getMessage());
            }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        Log.d(TAG, "OpenVPNService onStartCommand");
    ...
    private void startOpenVPN() {
        ...
        try {
            ...
            Log.e(TAG, "Error getting cache dir", e);
            tmpDir = "/tmp";
        }
    ...
    private OpenVPNManagement instantiateOpenVPN3Core() {
        try {
            Class cl = Class.forName("de.shellfire.vpn.android.openvpnOpenVPNThreadv3");
            ...
            Log.e(TAG, "Error instantiating OpenVPN3 Core", e);
        }
        return null;
    }
    ...
    public void onCreate() {
        super.onCreate();
        Log.d(TAG, "OpenVPNService created");
    }
    ...
    public ParcelFileDescriptor openTun() {
        ...
        if ("samsung".equals(Build.BRAND) && Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP && !mDnslist.isEmpty()) {
    ...
    private void doSendBroadcast(String state, ConnectionStatus level) {
        ...
        vpnstatus.setAction("de.shellfire.vpn.android.VPN_STATUS");
