...
import de.shellfire.vpn.android.openvpn.ConfigParser;
import de.shellfire.vpn.android.openvpn.ConfigParser.ConfigParseError;
...
public class ExternalOpenVPNService extends Service implements StateListener {
    ...
    private static final String TAG = "ExternalOpenVPNService";
    ...
    private final IOpenVPNAPIService.Stub mBinder = new IOpenVPNAPIService.Stub() {
        ...
        private void startProfile(VpnProfile vp) {
            ...
            if (vpnPermissionIntent != null || neddPassword != 0) {
                ...
                shortVPNIntent.setClass(getBaseContext(), de.shellfire.vpn.android.LaunchVPN.class);
                shortVPNIntent.putExtra(de.shellfire.vpn.android.LaunchVPN.EXTRA_KEY, vp.getUUIDString());
                shortVPNIntent.putExtra(de.shellfire.vpn.android.LaunchVPN.EXTRA_HIDELOG, true);
